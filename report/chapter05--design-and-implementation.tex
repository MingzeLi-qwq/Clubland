...
\begin{itemize}
    ...
    \item \textbf{Monolithic vs. Microservices Architecture} \\
    ...
    \item \textbf{Developing a Custom Rich Text Editor vs. Using a Third-Party Plugin} \\
    We considered implementing our own basic rich text features, but in terms of development 
    efficiency and stability, Django Summernote offered a reliable out-of-the-box solution.
\end{itemize}
